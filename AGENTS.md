...
| `internal/` | All real logic: `access`, `audit`, `auth`, `buildinfo`, `claudeauth`, `config`, `httpapi`, `loginrelay`, `release`, `session`, `tmuxctl`, `updater` |
