...
- 2026-08-05 — The fleet was rendered once and never updated, so a session created or reaped after the load stayed invisible until a manual reload; the spec now requires the refresh (FR-017a–d, SC-006a) and the page reloads on an interval the daemon chooses — never while the tab is hidden. (#15)
