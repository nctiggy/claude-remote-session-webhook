...
type fleetView struct {
	...
	// Outcome is what the action that redirected here did (#42), or nil.
	//
...
func (s *Server) dashboard(w http.ResponseWriter, r *http.Request) {
	...
	// action answered 303 and the browser came back with a GET (#42). Reading it
